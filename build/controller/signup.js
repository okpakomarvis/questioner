			...
			if (user.rowCount > 0) {
				...
				_bcrypt2.default.hash(req.body.password, 10, function (err, hash) {
					if (err) {
						...
						var queryUser = "INSERT INTO users(username, email, password, registered, isadmin)" + " VALUES($1, $2, $3, $4, $5) RETURNING *";
						var queryValue = [_username, _email, hash, new Date().toISOString(), true];
